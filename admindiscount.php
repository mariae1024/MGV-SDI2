      ...
      <div class="row">
          ...
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="admindiscount.php">
  ...
  <tbody>
           <?php 
		            while($r = mysqli_fetch_assoc($res)):?>
		            	<tr> 
		            		<td><?php echo $r['disc_code']; ?></td>
                            <td><?php echo $r['percentage']; ?></td>
                            <td>
                    
                           <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deletediscount<?php echo $r['id']; ?>">Delete</button>
                            </td>                           
 <div class="modal fade" id="deletediscount<?php echo $r['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="deletediscount" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalCenterTitle">Confirm delete discount action</h5>
          ...
          Are you sure you want to delete this discount?
             ...
             <a href="deletediscount.php?id=<?php echo $r['id']; ?>"><button type="button" class="btn btn-danger">Delete</button> 
              </a>   
          </div>
        </div>
      </div>
        ...
        <a href="adddiscount.php"><button type="button" class="btn btn-success">Add discount</button></a>          
          </div>
			</div>
