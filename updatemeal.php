...
$id = $_GET['id'];
$SelSql = "SELECT * FROM meals WHERE id=$id";
...
if(isset($_POST) & !empty($_POST)){
    ...
    $price = $_POST['price'];
    $status = $_POST['status'];
	$UpdateSql = "UPDATE meals SET name='$name', description='$description', ingredients='$ingredients', image='$image', price='$price', status='$status' WHERE id=$id";
