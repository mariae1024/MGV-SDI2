        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar nav-pills mt-3">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              <li class="nav-item">
                <a class="nav-link" href="newmenusuppliers.php">
                  <span class="fa fa-fw fa-lightbulb-o"></span>
                  New Menu
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" href="orderssuppliers.php">
           ...
           <?php 
		            while($r = mysqli_fetch_assoc($res)):?>
		            	<tr> 
                            ...
                            <td><a href="updateordersupplier.php?id=<?php echo $r['id']; ?>"><button type="button" class="btn btn-primary">Edit</button></a></td>
                        </tr>
                        <?php endwhile; ?>  
              </tbody>
