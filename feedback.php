...
<html lang="en">
  ...
  <li class="nav-item">
    <a class="nav-link" href="landingpage.php">Menu</a>
  </li>
  <li class="nav-item">
    ...
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="row">
        ...
        <!-- Modal -->
  <div class="modal fade" id="deletefeedback" tabindex="-1" role="dialog" aria-labelledby="deletefeedback" aria-hidden="true">
...
<table class="table table-striped table-sm">
  ...
  <tbody>
           <?php 
                    ...
                    <td>
                    <button type="button"  class="btn btn-sm btn-success" data-toggle="modal" data-target="#accept<?php echo $r['id'];?>">Reply</button>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalCenterTitle">Confirm Reply action</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
           ...
           <form method="POST" class="form-horizontal" action="replyfeedback.php?id=<?php echo $r['id']; ?>">
