...
$sql = "SELECT * FROM users LIMIT $page, $number_of_rows_per_page"; 
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h1 class="h2">Our Staff and Users</h1>
...
<table class="table table-striped table-sm">
  ...
  <tbody>
           <?php 
                    ...
                    <td>
                    <a href="edituser.php?id=<?php echo $r['id']; ?>"><button type="button" class="btn btn-primary">Edit</button></a>
