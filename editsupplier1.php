...
$id = $_GET['id'];
$SelSql = "SELECT * FROM supplier1 WHERE id=$id";
...
if(isset($_POST) & !empty($_POST)){
    ...
    $image = $_POST['image'];
    $price = $_POST['price'];
	$UpdateSql = "UPDATE supplier1 SET name='$name', description = '$description',ingredients ='$ingredients',image ='$image', price = '$price' WHERE id=$id";
