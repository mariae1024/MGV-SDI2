...
require_once('connect.php'); //to establish connection to database
$id = $_GET['id'];
            ...
            <form class="form-signin" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                ...
                <div class="form-row">
                  <div class="form-group col-md-12">
                        <label for="inputfname"><b>First Name: </b> <?php echo $r['first_name']; ?></label>
                ...
                <div class="form-row">
                  <div class="form-group col-md-12">
                        <label for="inputlname"><b>Last Name: </b><?php echo $r['last_name']; ?></label>
                        
                    </div>
                    
                    <div class="form-row">
                  <div class="form-group col-md-12">
                        <label for="inputdob"><b>Date of Birth: </b><?php echo $r['dob']; ?></label>
                ...
                <div class="form-row">
                 ...
                 <div class="form-row">
                  <div class="form-group col-md-12">
                        <label for="inputphone"><b>Phone number: </b><?php echo $r['phone_number']; ?></label>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <a href="changePass.php?id=<?php echo $r['id'] ?>"><button type="button" class="btn btn-warning btn-lg">Change password</button></a>
