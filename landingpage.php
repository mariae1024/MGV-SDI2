...
<div class="container-fluid" id="background">
          <div class="row">
              <div class="col">
                <h1><img src="logo2.png" width=500 height= 250></h1>
				<p id="slogan"><b>Why you need to cook when you have MGV.</b></p>
				<hr>
				<button class="btn btn-secondary btn-lg index-btn-color"><a href="Menu.php" style="color:white; text-decoration:blink;">Get Started</a></button><!-- connecting landing page to get started page-->
