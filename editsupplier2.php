...
$id = $_GET['id'];
$SelSql = "SELECT * FROM supplier2 WHERE id=$id";
...
if(isset($_POST) & !empty($_POST)){
    ...
    $image = $_POST['image'];
    $price = $_POST['price'];
	$UpdateSql = "UPDATE supplier2 SET name='$name', description = '$description',ingredients ='$ingredients',image ='$image', price = '$price' WHERE id=$id";
