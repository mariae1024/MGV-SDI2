...
$r = mysqli_fetch_assoc($res);
    ...
    $fname = $r['first_name'];
    $lname = $r['last_name'];
    $status = $r['status_delivery'];
    
	$UpdateSql = "UPDATE orders SET status_delivery ='Delivered' WHERE id=$id";
...
function sendAcceptReject($email,$fname,$lname){
     /* Create a new PHPMailer object. Passing TRUE to the constructor enables exceptions */
                ...
                try{
                    ...
                    $mail->Body = 'Hi, ' . $fname . ' ' . $lname . "\r\n\r\nThankyou for ordering from MGV. Your order has been delivered successfully.  \r\n\r\n Warm Regards \r\n Team MGV";
